...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { event_id: @gallery.event_id, name: @gallery.name, photo_challenge_id: @gallery.photo_challenge_id }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { event_id: @gallery.event_id, name: @gallery.name, photo_challenge_id: @gallery.photo_challenge_id }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
